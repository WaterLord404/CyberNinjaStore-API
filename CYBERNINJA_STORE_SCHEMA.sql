...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;-- CYBERNINJA_STORE_SYS.PRODUCTS definition
...
CREATE TABLE `ORDERS_DETAILS` (
  ...
  KEY `FK_ORDERS_DETAILS__ORDER_ID` (`ORDER_ID`),
  KEY `FK_ORDERS_DETAILS__PRODUCT_ID` (`PRODUCT_ID`),
  CONSTRAINT `FK_ORDERS_DETAILS__ORDER_ID` FOREIGN KEY (`ORDER_ID`) REFERENCES `ORDERS` (`ORDER_ID`),
  CONSTRAINT `FK_ORDERS_DETAILS__PRODUCT_ID` FOREIGN KEY (`PRODUCT_ID`) REFERENCES `PRODUCTS` (`PRODUCT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `USERS_roles` (
 ...
 INSERT INTO USERS
 (USER_ID, AUTH_ATTEMPS, CREATION_DATE, DELETE_DATE , ENABLED, LAST_PASS_CHANGE_DATE, LOCKED, PASSWORD, PASS_EXP_DATE, UPDATE_DATE, USERNAME, CUSTOMER_ID)
